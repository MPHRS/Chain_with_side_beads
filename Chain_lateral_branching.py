...
def chain(na, nb, box, period, length_side_chain):
    list_coord = list()
    list_bond = list()
    v = np.random.uniform(-1.0, 1.0, 3)
    x = v[0] * box.x/2
...
def show_bonds(fbonds, period, length_side_chain, chain_itself):
    temp = 0
